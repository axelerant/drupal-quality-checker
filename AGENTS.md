...
| --- | --- | --- |
| README.md | Engineers | Installing and customising the presets |
| docs/ | Engineers | How the plugin reaches a project, and why |
...
Run `docs_audit.py` against this checkout, and the repository's own tests.

## Where to look

| Need | Page |
| --- | --- |
| Install and customise | `README.md` |
| How it reaches a project | `docs/architecture.md` |
